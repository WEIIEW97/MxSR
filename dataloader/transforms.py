...
class RandomRotation(object):
    """
    Randomly rotates the images and disparity maps by 90 degrees increments.
    """
    ...
    def __call__(self, sample):
        ...
        if angle != 0:
            sample['left_image'] = torch.rot90(sample['left_image'], k=angle//90, dims=[2, 3])
            sample['right_image'] = torch.rot90(sample['right_image'], k=angle//90, dims=[2, 3])
            sample['left_disp'] = torch.rot90(sample['left_disp'], k=angle//90, dims=[2, 3])
            sample['right_disp'] = torch.rot90(sample['right_disp'], k=angle//90, dims=[2, 3])
        return sample